...
void setup() {
  ...
  maxFlights = Collections.max(flights.numberOfFlights);
}
void draw() {
  background(255);
  lights();
  translate(width / 2, height / 2);
  stroke(0, 255, 0);   line(500,0,0,-500,0,0);  stroke(0, 0, 255);   line(0, -500, 0,0, 500, 0);   stroke(255, 0, 0);   line(0,0,500,0,0,-500);  
