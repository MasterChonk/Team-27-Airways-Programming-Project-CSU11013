void WidgetCreation(PFont airlineFont, PFont selectorFont, PFont headerFont, PFont regularFont, PFont boldRegularFont) {   
  // Home Screen Widgets
  ToggleWidget toggle = new ToggleWidget(toggleX, toggleY, toggleCircleWidth, toggleCircleGap, WHITE, GREY, ORANGE, false);
  ...
  EmptyWidget latenessLabel = new EmptyWidget(toggleLabelX, toggleLabelY, toggleLabelWidth, rowHeight, corner, CENTER, "Lateness", BLUE_BLACK, WHITE, selectorFont, true);
